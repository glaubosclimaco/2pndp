...
int main (int argc, char *argv[])
{
	...
	for(i=inicial;i<inicial+total;i++){
		...
		times(&ti);
		custo = GRASP_PRBF_MINE(nnos, ndemandas, demanda, incidencia, num_vezes, &semente, solucao,melhor_solucao,pool_solucao,pool_custo, alvo,sup_min,qnt_padroes,qnt_elite,&t_miner);
		times(&tf);
